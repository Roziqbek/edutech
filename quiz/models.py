...
class Test(models.Model):
  ...
  end_date = models.DateTimeField(default=(timezone.now()+timezone.timedelta(days=100)))
...
class Question(models.Model):
  ...
  true_answer = models.CharField(max_length=150,help_text='E.x: a ',choices=choice)
...
class CheckQuestion(models.Model):
  ...
  given_answer = models.CharField(max_length=2, help_text='E.x: a')
  true_answer = models.CharField(max_length=2, help_text='E.x: a')
...
def check_answer(sender,instance,*args,**kwargs):
  ...
  print(checktest.finded_questions)
  try:
